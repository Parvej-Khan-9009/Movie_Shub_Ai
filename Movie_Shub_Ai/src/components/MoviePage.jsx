  ...
  return (
    <div className="w-full">
      <div
        ...
        } lg:pb-4 pb-2 bg-gradient-to-b from-gray-800 via-gray-900 to-[#3b2e2e]`}
      >
        <div className="md:pt-[75px] sm:pt-[70px] pt-[55px] xl:w-[75%] lg:w-[80%] md:w-[90%] w-[96%] mx-auto ">
              ...
              {mediaData?.runtime && (
                <div className="relative  xs:block flex items-center gap-[2px]">
                  ...
                  <div className="flex items-center sm:gap-1 gap-[1px] justify-center">
                    ...
                    <span className="font-medium md:text-base sm:text-sm text-xs">
          ...
          <div className="w-full sm:block flex xs:gap-3 gap-[6px]">
            ...
            <div className="sm:w-full w-[75%] pr-1">
              ...
              {mediaData?.genres?.length != 0 && (
                <div className="w-full sm:flex hidden lg:pt-2 sm:pt-1 items-center md:text-lg sm:text-base font-semibold">
              ...
              <div
                className={
                  overview
                    ? "md:pt-[2px] pt-2 md:text-base xs:text-sm text-[12px] text-justify xs:leading-[auto] leading-[15px]"
          ...
          {mediaData?.genres?.length != 0 && (
            <div className="w-full sm:hidden pt-2 flex gap-[2px] items-center text-sm font-semibold ">
              {mediaData?.genres?.map((item, index) => {
                if (index > 2) return null;
                let show = true;
                if (index + 1 == mediaData?.genres?.length || index == 2) {
