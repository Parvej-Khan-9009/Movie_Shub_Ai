...
import { GET_API_OPTION, NOW_PLAYING_API, TRAILER_DATA_API } from "../utils/Constant";
...
function MainContainer() {
  ...
  async function getTrailerKey() {
    const res = await fetch( TRAILER_DATA_API + "/videos?language=en-US", GET_API_OPTION);
  ...
  async function getNowPlaying() {
    const response = await fetch( NOW_PLAYING_API, GET_API_OPTION);
    ...
    <div className="relative w-full lg:h-screen">
      <div className="relative lg:h-screen lg:w-full w-screen aspect-video">
        <div className="relative lg:mt-0 md:mt-[62px] sm:mt-[58px] mt-[47px] w-full lg:h-screen lg:overflow-hidden">
          <div
            id="youtube-player"
            className="lg:absolute xl:top-[-20px] lg:w-[1520px] lg:h-[855px] w-full h-full aspect-video shadow-xl border border-gray-800 mx-auto"
          ></div> 
            ...
            <div className="xl:pl-[66px] lg:pl-[49px] md:pl-[47px] sm:pl-2 pl-1 sm:text-xl lg:pt-[220px] md:pt-32 sm:pt-16 pt-[70px]">
              ...
              <div className="flex justify-between items-center">
                <a
                  ...
                  href={ "browse/movieOrTv/" + "movie" + "/762509"}>
