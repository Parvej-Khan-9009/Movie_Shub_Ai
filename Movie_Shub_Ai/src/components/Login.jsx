...
import { BG_URL, AVATAR } from "../utils/Constant";
import { dataValidation } from "../utils/validate";
import { createUserWithEmailAndPassword, onAuthStateChanged, signInWithEmailAndPassword, updateProfile } from "firebase/auth";
import auth from "../utils/firebase";  // Initializing firebase and getting auth for signin and signup.
    ...
    <>
      ...
      >
        <div className="w-full h-screen bg-black bg-opacity-60 flex flex-col">
          ...
          <img 
              className="md:w-32 w-[100px]"
              src="/website_logo.png"
            />
          </div>
  
          <div className="flex lg:mt-12 md:mt-5 sm:mt-7 mt-20 justify-center">
            <form
            ...
            >
              ...
              {!isSignIn && (
                <div className="mt-6">
                  <input
                    className="w-full bg-transparent px-4 xs:py-3 py-2 text-white font-medium border rounded-md border-gray-600"
                    ref={name}
                    type="text"
                    required
              ...
              <div className="mt-6">
                <input
                  className="w-full bg-transparent px-4 xs:py-3 py-[10px] text-white font-medium border rounded-md border-gray-600"
                  ref={email}
                  type="email"
                  required
